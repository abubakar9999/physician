...
class PatientCallBoardMeeting extends StatefulWidget {
  const PatientCallBoardMeeting({super.key});
  @override
  State<PatientCallBoardMeeting> createState() => _PatientCallBoardMeetingState();
}

class _PatientCallBoardMeetingState extends State<PatientCallBoardMeeting> with WidgetsBindingObserver {
  final databox = Boxes.allData();
  String cid = '';
  String userId = '';
  String userPassword = '';
  String board_meeting_submit_url = '';
  String? deviceId = '';
  ...
  void initState() {
    ...
    board_meeting_submit_url = databox.get("board_meeting_submit_url") ?? '';

    _lastSuccessfulUrl = '$board_meeting_submit_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Patient Call & Board Meeting', style: TextStyle(color: Colors.white)),
          actions: [
            Row(
              children: <Widget>[
                // IconButton(
...
// }
//
// class _PatientCallBoardMeetingState extends State<PatientCallBoardMeeting> {
...
//   @override
//   Widget build(BuildContext context) {
//     debugPrint('patient call & board meeting url: $board_meeting_submit_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId');
//     return WillPopScope(
//       onWillPop: () async {
...
//       child: Scaffold(
//         appBar: AppBar(
//           title: const Text("Patient Call & Board Meeting"),
//           leading: IconButton(
//               onPressed: () async {
...
//                       url: WebUri('$board_meeting_submit_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId')),
