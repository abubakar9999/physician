...
class _ExamPageState extends State<ExamPage> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    examUrl = databox.get("exam_url") ?? '';

    _lastSuccessfulUrl = '$examUrl?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId';
...
//   @override
//   Widget build(BuildContext context) {
//     debugPrint('exam url: $examUrl?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId');
//     return WillPopScope(
//       onWillPop: () async {
...
//                       url: WebUri('$examUrl?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId')),
