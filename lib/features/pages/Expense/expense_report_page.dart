...
class _ExpenseReportPageState extends State<ExpenseReportPage>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    _lastSuccessfulUrl = '$expense_report?cid=$cid&rep_id=$userId&rep_pass=$userPassword';
...
//   @override
//   Widget build(BuildContext context) {
//     debugPrint('$expense_report?cid=$cid&rep_id=$userId&rep_pass=$userPassword');
//     return WillPopScope(
//       onWillPop: () async {
...
//                       //url: Uri.parse('$expense_report?cid=$cid&rep_id=$userId&rep_pass=$userPassword')),
//                       url: WebUri('$expense_report?cid=$cid&rep_id=$userId&rep_pass=$userPassword')),
