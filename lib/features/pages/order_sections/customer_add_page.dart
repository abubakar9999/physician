...
class CustomerAddPage extends StatefulWidget {
  ...
  CustomerAddPage({
    super.key, required this.terriId,
  });
  @override
  State<CustomerAddPage> createState() => _CustomerAddPageState();
}

class _CustomerAddPageState extends State<CustomerAddPage>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    _lastSuccessfulUrl = '$client_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&terri_id=${widget.terriId}';
...
//               child: InAppWebView(
//                // initialUrlRequest: URLRequest(url: Uri.parse("$client_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&terri_id=${widget.terriId}")),
//                 initialUrlRequest: URLRequest(url: WebUri("$client_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&terri_id=${widget.terriId}")),
