...
class _OutstandingPageState extends State<OutstandingPage>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    _lastSuccessfulUrl = '$repOutsUrl?cid=$cid&rep_id=$userId&rep_pass=$userPassword&client_id=${widget.clientId}';
...
//                     //url: Uri.parse("$repOutsUrl?cid=$cid&rep_id=$userId&rep_pass=$userPassword&client_id=${widget.clientId}")),
//                     url: WebUri("$repOutsUrl?cid=$cid&rep_id=$userId&rep_pass=$userPassword&client_id=${widget.clientId}")),
