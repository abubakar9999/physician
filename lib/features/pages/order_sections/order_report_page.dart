...
class OrderReportWebViewScreen extends StatefulWidget {
  ...
  OrderReportWebViewScreen({
    super.key,required this.cid,required this.userId, required this.userPassword,required this.report_url
  });
  @override
  State<OrderReportWebViewScreen> createState() => _OrderReportWebViewScreenState();
}

class _OrderReportWebViewScreenState extends State<OrderReportWebViewScreen>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    _lastSuccessfulUrl = '${widget.report_url}?cid=${widget.cid}&rep_id=${widget.userId}&rep_pass=${widget.userPassword}&device_id=$deviceId"';
...
//   @override
//   Widget build(BuildContext context) {
//     print("xx:  ${widget.report_url}?cid=${widget.cid}&rep_id=${widget.userId}&rep_pass=${widget.userPassword}&device_id=$deviceId");
...
//                           //url: Uri.parse("${widget.report_url}?cid=${widget.cid}&rep_id=${widget.userId}&rep_pass=${widget.userPassword}&device_id=$deviceId")),
//                           url: WebUri("${widget.report_url}?cid=${widget.cid}&rep_id=${widget.userId}&rep_pass=${widget.userPassword}&device_id=$deviceId")),
