...
class _CustomerEditPageState extends State<CustomerEditPage>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    _lastSuccessfulUrl = '$client_edit_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&client_id=${widget.clientId}';
...
//   @override
//   Widget build(BuildContext context) {
//     print("$client_edit_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&client_id=${widget.clientId}");
//     return Scaffold(
//       appBar: AppBar(
...
//               child: InAppWebView(
//                 //initialUrlRequest: URLRequest(url: Uri.parse("$client_edit_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&client_id=${widget.clientId}")),
//                 initialUrlRequest: URLRequest(url: WebUri("$client_edit_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&client_id=${widget.clientId}")),
