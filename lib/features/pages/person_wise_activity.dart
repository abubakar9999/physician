...
class PersonWiseActivity extends StatefulWidget {
  PersonWiseActivity({
    super.key,
  });
  @override
  State<PersonWiseActivity> createState() => _PersonWiseActivityState();
}

class _PersonWiseActivityState extends State<PersonWiseActivity>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    _lastSuccessfulUrl = '$activity_log_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId';
...
// }
//
// class _PersonWiseActivityState extends State<PersonWiseActivity> {
...
//   @override
//   Widget build(BuildContext context) {
//     log('aa: $activity_log_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId');
//     return WillPopScope(
//       onWillPop: () async {
...
//       child: Scaffold(
//         appBar: AppBar(
//           title: const Text("Person Wise Activity"),
//           leading: IconButton(
//               onPressed: () async {
...
//                 child: InAppWebView(
//                   //initialUrlRequest: URLRequest(url: Uri.parse('$activity_log_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&device_id=$deviceId')),
//                   initialUrlRequest: URLRequest(url: WebUri('$activity_log_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId')),
