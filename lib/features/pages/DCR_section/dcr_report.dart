...
class VisitReportPage extends StatefulWidget {
  VisitReportPage({super.key});
  @override
  State<VisitReportPage> createState() => _VisitReportPageState();
}

class _VisitReportPageState extends State<VisitReportPage> with WidgetsBindingObserver {
  final databox = Boxes.allData();
  String cid = '';
  String userId = '';
  String userPassword = '';
  String visiReportUrl = '';
  String? deviceId = '';
  ...
  void initState() {
    ...
    visiReportUrl = databox.get("visit_report_url") ?? '';

    _lastSuccessfulUrl = '$visiReportUrl?cid=$cid&user_id=$userId&user_pass=$userPassword';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Visit Report', style: TextStyle(color: Colors.white)),
          actions: [
            Row(
              children: <Widget>[
                // IconButton(
...
//   @override
//   Widget build(BuildContext context) {
//     debugPrint('visit report url: $visiReportUrl?cid=$cid&user_id=$userId&user_pass=$userPassword');
//     return WillPopScope(
//       onWillPop: () async {
...
//                       url: WebUri('$visiReportUrl?cid=$cid&user_id=$userId&user_pass=$userPassword')),
