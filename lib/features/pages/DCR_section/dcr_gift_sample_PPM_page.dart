...
class _DcrGiftSamplePpmPageState extends State<DcrGiftSamplePpmPage> {
  ...
  _onItemTapped(int index) async {
    ...
    if (index == 1) {
      ...
      bool hasMinimalVisitInfo = hasNonExecution ||
          ((imagePath != null || widget.image1 != '') &&
              selectedDeliveryTime!.isNotEmpty &&
              visitedPersonController.text.isNotEmpty);
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                FittedBox(
                                  child: Text(
                                    "${widget.officeName} | ${widget.orgName}",
                                    style: const TextStyle(
                                ...
                                FittedBox(
                                  child: Text(
                                    "${widget.areaName} | ${widget.areaId} | ${widget.category}",
                                    style: const TextStyle(
                                        color:
                                            ...
                                            return AlertDialog(
                                              content: SingleChildScrollView(
                                                child: Column(
                                                  ...
                                                  children: dcr_visitedWithList.asMap().entries.map((entry) {
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Expanded(
                                          child: Text(
                                            visitedWithString.isEmpty ? drftVisitShow : visitedWithString,
                              ...
                              child: Stack(
                                children:[
                                  ...
                                  child: DropdownButton<String>(
                                    ...
                                    isExpanded: true,
                                    items: deliveryTime.map((String item) {
                                      return DropdownMenuItem<String>(
                                            value: item,
                                            child: Text(
                                              item,
                           ...
                           Stack(
                             children:[
                               ...
                               const Positioned(
                                 top: 8,
                                 right: 5,
                                 child: Icon(Icons.star_sharp, color: Colors.red,
                                     size: 12),
                               ),
                             ]
                           )
  ...
  Future<void> getDcrGitData() async {
    ...
    try {
      ...
      print('API URL for getDcrGitData: '
          //'http://192.168.100.219:8000/physician_api/api_gift_sample_ppm/get_phy_gift?cid=$cid&user_id=$userId&user_pass=$userPassword'
          "${syncUrl}api_gift_sample_ppm/get_phy_gift?cid=$cid&user_id=$userId&user_pass=$userPassword"
      );
      ...
      if (response.statusCode == 200) {
        ...
        if (resData['giftList'] != null && resData['giftList'].isNotEmpty) {
          ...
          Fluttertoast.showToast(
              msg: "No Gift Found from API", backgroundColor: Colors.red);

        }
      } else {
        Fluttertoast.showToast(
            msg: 'Failed to load gift data.',
            backgroundColor: Colors.red,
            textColor: Colors.white,
            fontSize: 16.0);
  ...
  Future<void> getDcrSampleData() async {
    ...
    try {
      ...
      print('API URL for getDcrSampleData: '
          //'http://192.168.100.219:8000/physician_api/api_gift_sample_ppm/get_phy_sample?cid=$cid&user_id=$userId&user_pass=$userPassword'
          "${syncUrl}api_gift_sample_ppm/get_phy_sample?cid=$cid&user_id=$userId&user_pass=$userPassword"
      );
      ...
      if (response.statusCode == 200) {
        ...
        if (resData['sampleList'] != null && resData['sampleList'].isNotEmpty) {
          ...
          Fluttertoast.showToast(
              msg: "No Sample Found from API", backgroundColor: Colors.red);
      ...
      Fluttertoast.showToast(
          msg: 'Error fetching sample data.',
          backgroundColor: Colors.red,
          textColor: Colors.white,
          fontSize: 16.0);
  ...
  Future<void> getDcrPpmData() async {
    ...
    try {
      ...
      print('API URL for getDcrPpmData: '
          //'http://192.168.100.219:8000/physician_api/api_gift_sample_ppm/get_phy_ppm?cid=$cid&user_id=$userId&user_pass=$userPassword'
          "${syncUrl}api_gift_sample_ppm/get_phy_ppm?cid=$cid&user_id=$userId&user_pass=$userPassword"
      );
      ...
      if (response.statusCode == 200) {
        ...
        if (resData['ppmList'] != null && resData['ppmList'].isNotEmpty) {
          ...
          Fluttertoast.showToast(
              msg: "No PPM Found from API", backgroundColor: Colors.red);

        }
      } else {
        Fluttertoast.showToast(
            msg: 'Failed to load PPM data.',
            backgroundColor: Colors.red,
            textColor: Colors.white,
            fontSize: 16.0);
  ...
  Future<dynamic> rxImageUpload() async {
    ...
    if (widget.image1 != '') {
      ...
      if (fileName != '' && status == "Success") {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Image submit Failed'),
              backgroundColor: Colors.red),
        );
      }
    }
