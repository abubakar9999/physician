...
//
//
// class LastDoctorVisitPage extends StatefulWidget {
//   LastDoctorVisitPage({
//     super.key,
//     required this.docId,
//   });
...
//
//   @override
//   State<LastDoctorVisitPage> createState() => _LastDoctorVisitPageState();
// }
//
// class _LastDoctorVisitPageState extends State<LastDoctorVisitPage> {
//   double progress = 0;
//   final databox = Boxes.allData();
//   String cid = '';
//   String userId = '';
//   String userPassword = '';
//   String lastDoctorVisitUrl = '';
//
//   @override
//   void initState() {
//     cid = databox.get("CID")!;
...
//     lastDoctorVisitUrl = databox.get("report_last_doc_visit_url") ?? "";
//
//     super.initState();
//   }
//
...
//         "$lastDoctorVisitUrl?cid=$cid&rep_id=$userId&password=$userPassword&doc_id=${widget.docId}"
//     );
//     return Scaffold(
//       appBar: AppBar(
//         title: Text("Last Doctor Visit"),
//       ),
//       body: Container(
