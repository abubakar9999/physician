...
class _DcrGiftDataPageState extends State<DcrGiftDataPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.blue, title: const Text('Gift', style: TextStyle(color: Colors.white)), titleTextStyle: const TextStyle(fontWeight: FontWeight.w500, fontSize: 20), centerTitle: true),
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  Text(foundUsers[index]['gift_name'], style: const TextStyle(color: Color.fromARGB(255, 30, 66, 77), fontSize: 18)),
                                                  const SizedBox(width: 10),
                                                  foundUsers[index]['gift_left_qty'] == 0
                                              ...
                                              Text(foundUsers[index]['gift_id'], style: const TextStyle(color: Color.fromARGB(255, 30, 66, 77), fontSize: 16)),
                                            ],
                                          ),
                                        ),
                                        Expanded(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    onChanged: (value) {
                                                      ...
                                                      if (inputQty > leftQty) {
                                                        ...
                                                        controllers[key]!.selection = TextSelection.fromPosition(TextPosition(offset: controllers[key]!.text.length));
                                                        return;
                                                      }
                                                      ...
                                                      if (inputQty > 0) {
                                                        final model = DcrGSPDataModel(uiqueKey: widget.uniqueId, quantity: inputQty, giftName: gift['gift_name'], giftId: gift['gift_id'], giftType: gift['promo_type']);

                                                        widget.tempList.removeWhere((item) => item.giftId == model.giftId && item.giftType == model.giftType);
                                                        widget.tempList.add(model);
                                                      } else {
                                                        widget.tempList.removeWhere((item) => item.giftId == gift['gift_id'] && item.giftType == gift['promo_type']);
                                                      }
                                                    },
                                                  ),
                                                ),
