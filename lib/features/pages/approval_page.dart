...
class _ApprovalPageState extends State<ApprovalPage>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    _lastSuccessfulUrl = '$approval_url?cid=$cid&user_id=$userId&user_pass=$userPassword';
...
//                      // url: Uri.parse('$approval_url?cid=$cid&user_id=$userId&user_pass=$userPassword')),
//                       url: WebUri('$approval_url?cid=$cid&user_id=$userId&user_pass=$userPassword')),
