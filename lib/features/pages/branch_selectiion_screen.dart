...
class BranchSelectiionScreen extends StatefulWidget {
  const BranchSelectiionScreen({Key? key}) : super(key: key);

  @override
  State<BranchSelectiionScreen> createState() => _DoctorTerritoryPageState();
}

class _DoctorTerritoryPageState extends State<BranchSelectiionScreen> {
  List doctorData = [];
  List doctorList = [];
                       ...
                       final raw = foundUsers[index]["branch"].toString();
                        ...
                        return InkWell(
                          onTap: () async {
                            ...
                            //       branchId: doctor.contains('|') ? doctor.split('|')[1] : doctor,
                            //       branchName: doctor.contains('|') ? doctor.split('|')[0] : doctor,
                            //     ),
                            //   ),
                            // );
                            setState(() {});
