...
class StructureWiseActivity extends StatefulWidget {
  const StructureWiseActivity({
    super.key,
  });
  @override
  State<StructureWiseActivity> createState() => _StructureWiseActivityState();
}

class _StructureWiseActivityState extends State<StructureWiseActivity>  with WidgetsBindingObserver  {
  final databox = Boxes.allData();
  String cid = '';
  String userId = '';
  String userPassword = '';
  String activity_log_areawise_url = '';
  String? deviceId = '';
  ...
  void initState() {
    ...
    activity_log_areawise_url = databox.get("activity_log_areawise_url") ?? '';

    _lastSuccessfulUrl = '$activity_log_areawise_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId';
...
// }
//
// class _StructureWiseActivityState extends State<StructureWiseActivity> {
...
//   @override
//   Widget build(BuildContext context) {
//     log('aa: $activity_log_areawise_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId');
//     return WillPopScope(
//       onWillPop: () async {
...
//       child: Scaffold(
//         appBar: AppBar(
//           title: const Text("Structure Wise Activity"),
//           leading: IconButton(
//               onPressed: () async {
...
//                 child: InAppWebView(
//                   //initialUrlRequest: URLRequest(url: Uri.parse('$activity_log_areawise_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&device_id=$deviceId')),
//                   initialUrlRequest: URLRequest(url: WebUri('$activity_log_areawise_url?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId')),
