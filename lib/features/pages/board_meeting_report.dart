...
class BoardMeetingReport extends StatefulWidget {
  BoardMeetingReport({super.key});
  @override
  State<BoardMeetingReport> createState() => _BoardMeetingReportState();
}

class _BoardMeetingReportState extends State<BoardMeetingReport> with WidgetsBindingObserver {
  final databox = Boxes.allData();
  String cid = '';
  String userId = '';
  String userPassword = '';
  String patientCallBoardMeetingReportUrl = '';
  String? deviceId = '';
  ...
  void initState() {
    ...
    patientCallBoardMeetingReportUrl = databox.get("board_meeting_report_url") ?? '';

    _lastSuccessfulUrl = '$patientCallBoardMeetingReportUrl?cid=$cid&user_id=$userId&user_pass=$userPassword';
...
// }
//
// class _BoardMeetingReportState extends State<BoardMeetingReport> {
...
//   @override
//   Widget build(BuildContext context) {
//     debugPrint('board meeting report url: $patientCallBoardMeetingReportUrl?cid=$cid&user_id=$userId&user_pass=$userPassword');
//     return WillPopScope(
//       onWillPop: () async {
...
//                       url: WebUri('$patientCallBoardMeetingReportUrl?cid=$cid&user_id=$userId&user_pass=$userPassword')),
