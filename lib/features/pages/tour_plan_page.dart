...
class _TourPlanPageState extends State<TourPlanPage>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    _lastSuccessfulUrl = '$tour_plan_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&device_id=$deviceId';
...
//   @override
//   Widget build(BuildContext context) {
//     print('111: $tour_plan_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&device_id=$deviceId');
//     return WillPopScope(
//       onWillPop: () async {
...
//                       //url: Uri.parse('$tour_plan_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&device_id=$deviceId'),
//                       url: WebUri('$tour_plan_url?cid=$cid&rep_id=$userId&rep_pass=$userPassword&device_id=$deviceId'),
//                   ),
