...
class _ExamResultPageState extends State<ExamResultPage>  with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    examResultUrl = databox.get("exam_result_url") ?? '';

    _lastSuccessfulUrl = '$examResultUrl?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId';
...
//   @override
//   Widget build(BuildContext context) {
//     debugPrint('exam result url: $examResultUrl?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId');
//     return WillPopScope(
//       onWillPop: () async {
...
//                       url: WebUri('$examResultUrl?cid=$cid&user_id=$userId&user_pass=$userPassword&device_id=$deviceId')),
