...
class _PrescriptionReportPageState extends State<PrescriptionReportPage> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    prescriptionReportUrl = databox.get("prescription_report_url") ?? '';
...
// }
//
// class _PrescriptionReportPageState extends State<PrescriptionReportPage> {
...
//   @override
//   Widget build(BuildContext context) {
//     debugPrint('seen prescription report url: $prescriptionReportUrl?cid=$cid&user_id=$userId&user_pass=$userPassword');
//     return WillPopScope(
//       onWillPop: () async {
...
//       child: Scaffold(
//         appBar: AppBar(
//           title: const Text("Seen Prescription Report"),
//           leading: IconButton(
//               onPressed: () async {
...
//                       url: WebUri('$prescriptionReportUrl?cid=$cid&user_id=$userId&user_pass=$userPassword')),
